...
namespace Micro_Project
{
    public class SecondQuery
    {
        ...
        public SecondQuery(string Name, string Surname, string Lastname, string Nomer, string Caterogy, string StartLive, string EndLive, string Days, string Summa, string Desc)
        {
            this.name = Name;
